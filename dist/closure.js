...
function closure() {
     ...
     */
    function isTheDateValid(dateObj) {
    ...
    return {
         ...
         */
        prevMonth: function () {
            var prevMonthDate = new Date(dateObject.getFullYear(), dateObject.getMonth() - 1, 1);
         ...
         */
        nextMonth: function () {
            var nextMonthDate = new Date(dateObject.getFullYear(), dateObject.getMonth() + 1, 1);
         ...
         */
        manuallySetDate: function (newDate) {
